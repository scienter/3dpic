EXEC = show
CC = mpicc 
OBJS = main.o parameterSetting.o findparam.o boundary.o loadPlasma3D.o saveFile.o fieldSolve.o loadLaser.o fieldShareY_DSX.o fieldShareZ_DSX.o interpolation.o particlePush.o rearrangeParticles.o particleShareY.o
